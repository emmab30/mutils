...
*/
export const getContract = (provider: typeof IProvider, address: string) => {
...
*/
export const getPrice = async (prov: typeof IProvider, fromAddress: string, toAddress: string, amount: number | string = 1) => {
